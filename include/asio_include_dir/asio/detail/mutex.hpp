...
# include "asio_include_dir/asio/detail/null_mutex.hpp"
#elif defined(ASIO_WINDOWS)
# include "asio_include_dir/asio/detail/win_mutex.hpp"
#elif defined(ASIO_HAS_PTHREADS)
# include "asio_include_dir/asio/detail/posix_mutex.hpp"
#elif defined(ASIO_HAS_STD_MUTEX_AND_CONDVAR)
# include "asio_include_dir/asio/detail/std_mutex.hpp"
#else
